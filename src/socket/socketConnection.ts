...
// const SERVER_URL = process.env.NODE_ENV === "production" ? process.env.PROD_API_URL : process.env.LOCAL_API_URL;
const SERVER_URL = "https://whatsapp-server-mgm7.onrender.com";
